      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 text-2xl font-red-hat-display">
              Um pouco das soluções e serviços que podemos ofertar.
            </h2>
          </div>
          ...
          >
            {/* 1st item */}
            <a
              className="flex flex-col p-5 group text-white bg-gradient-to-tr from-teal-500 to-teal-400 dark:to-teal-500 shadow-2xl rounded-md"
              href="#0"
              data-aos="fade-down"
